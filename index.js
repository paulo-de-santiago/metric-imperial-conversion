...
function meterFeet(inputValue) {
    ...
    let meter = 0.304800; // meter
    let feet = 3.281 //feet
    
   let feetConversion = value  * feet; 
   let meterConversion = value  * meter;
   
   let meterFeet = `<p>${value} meters = ${feetConversion.toFixed(3)} feet | ${value} feet = ${meterConversion.toFixed(3)} meters </p>`
...
function literGallon(inputValue) {
   ...
   let literGallon = `<p>${value} liters = ${gallonConversion.toFixed(3)} gallons| ${value} gallons = ${literConversion.toFixed(3)} liters</p>`
...
function kiloPounds(inputValue) {
   ...
   let kiloPounds = `<p>${value} kilos = ${poundConversion.toFixed(3)} pounds | ${value} pounds = ${kiloConversion.toFixed(3)} kilos</p>`
